...
export const projects: Project[] = [
  {
    ...
    category: "Web / System",
    thumbnail: "src/attachments/thumbnail magang.png",
    ...
    year: 2024,
    featured: true,
    certificate: "src/attachments/certificates/SERTIKASI_MAGANG_SANJAYA.pdf",
    demoUrl: "src/attachments/thumbnail magang.png",
  },
  {
    id: "2",
    ...
    category: "IoT / Data",
    thumbnail: "src/attachments/thumbnail IoT.jpeg",
    ...
    year: 2024,
    featured: true,
    certificate: "src/attachments/certificates/SKL (surat keterangan lulus).pdf",
  ...
  },
  {
    ...
    category: "Marketing",
    thumbnail: "src/attachments/Digital Marketing.jpeg",
    ...
    year: 2024,
    featured: true,
    certificate: "src/attachments/certificates/Digital Marketing Sertifikat Kelulusan - Sanjaya.pdf",
    demoUrl: "src/attachments/Digital Marketing.jpeg",
  },
];
...
export const certificates: Certificate[] = [
  {
    ...
    name: "TOEFL",
    issuer: "ETS",
    certificateUrl: "src/attachments/certificates/Toefl-10121186.pdf",
  },
  {
    id: "cert2",
    name: "BNSP",
    issuer: "Badan Nasional Sertifikasi Profesi",
    certificateUrl: "src/attachments/certificates/SERTIKASI_BNSP_SANJAYA.pdf",
  },
];
